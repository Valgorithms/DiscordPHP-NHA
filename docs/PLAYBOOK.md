...
flowchart TD
    ...
    exp --> refused{"the game refused this exact intent recently?<br/>&#40;state.recentRefusal: 300 ticks, 60 if transient&#41;"}
    refused -- yes --> earnR["earnStep: do something else"] --> rec
    refused -- no --> rec
